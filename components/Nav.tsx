...
export const Nav = memo(function Nav() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 p-6 lg:p-10 flex justify-between items-start pointer-events-none">
      ...
      <div className="flex flex-col items-end gap-2">
        <div className="font-mono text-[9px] text-ivory uppercase tracking-[0.4em] opacity-80 flex gap-4 pointer-events-auto">
          <a href="#the-verse" className="hover:text-gold transition-colors drop-shadow-md bg-void/50 px-3 py-1.5 border border-ivory/10 backdrop-blur-md hover:bg-ivory/5">The Verse</a>
        </div>

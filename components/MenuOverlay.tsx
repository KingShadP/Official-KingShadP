        ...
        >
          ...
          <div className="w-full h-full flex flex-col md:flex-row">
            ...
            <div className="flex-1 h-full flex flex-col justify-center px-8 lg:px-24 pt-32 pb-24 border-l border-ivory/10">
              <nav className="flex flex-col gap-8 md:gap-12 relative z-10 w-full md:items-end md:text-right">
                <a
                  href="#the-verse"
                  onClick={onClose}
                  className="font-serif text-5xl lg:text-7xl font-light italic text-ivory hover:text-gold transition-colors focus:outline-none focus:ring-2 focus:ring-gold group"
                >

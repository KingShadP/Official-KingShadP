...
export default async function ShopPage() {
  ...
  return (
    <PagePrelude
      pageKey="shop"
      bootLabel="Shop"
      heading="Physical pieces from the house."
      body="This room is for acquisition: garments, objects, and future drops, with a try-on studio ready for AI fitting once the provider is connected."
      enterLabel="Enter Shop"
      backdropSrc={SITE_MEDIA.collectionMark}
    >
